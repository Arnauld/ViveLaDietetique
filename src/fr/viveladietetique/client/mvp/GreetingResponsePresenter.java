...
import fr.viveladietetique.shared.event.GreetingSentEventHandler;
...
//				sendButton.setFocus(true);
		...
		eventBus.addHandler(GreetingSentEvent.TYPE, new GreetingSentEventHandler() {
			...
			/* (non-Javadoc)
			 * @see fr.viveladietetique.shared.event.GreetingSentEventHandler#onGreetingSent(fr.viveladietetique.shared.event.GreetingSentEvent)
			 */
